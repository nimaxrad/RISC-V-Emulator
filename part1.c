...
void write_lswc(Instruction instruction) {
    print_rtype("lswc", instruction);
}
...
// 00000000000000000000 111110011000 : 3992 : WHAT WE GOT
// 11111111111111111111 111110011000 : -104 : OPTIMAL SOL
